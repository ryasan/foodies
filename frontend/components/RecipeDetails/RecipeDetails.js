...
import PIN_DETAILS_QUERY from '../../graphql/queries/recipeDetails';
import ErrorMessage from '../ErrorMessage/ErrorMessage';
import DeleteRecipe from '../DeleteRecipe/DeleteRecipe';

const RecipeDetails = ({ recipeId, currentUserId }) => {
  return (
    <Query query={PIN_DETAILS_QUERY} variables={{ recipeId }}>
          ...
          <>
            ...
            <RecipeDetailsStyles>
              <div className="column img-container">
                <img src={recipeDetails.largeImage} alt={recipeDetails.title} />
              </div>
              <div className="column details-container">
                ...
                <div className="footer">
                  <p>Post by: {recipeDetails.creatorUsername}</p>
                  {ownsRecipe && <DeleteRecipe recipeId={recipeId} />}
                </div>
              </div>
            </RecipeDetailsStyles>
          </>
